...
- [Getting started with PHP on AWS Lambda - Berlin PHP Usergroup](https://github.com/thomasbley/talks/blob/master/Getting_started_aws_lambda_bephpug_2019_ThomasBley.pdf)
- [Getting started with PHP on AWS Lambda - code.talks commerce](https://github.com/thomasbley/talks/blob/master/Getting_started_aws_lambda_codetalks_2019_ThomasBley.pdf)
- [Getting started with PHP on AWS Lambda - IPC](https://github.com/thomasbley/talks/blob/master/Getting_started_aws_lambda_ipc_2019_ThomasBley.pdf)

### 2021

- [Getting Started with PHP-FFI - IPC](https://github.com/thomasbley/talks/blob/master/Getting_started_with_phpffi_ipc_2021_ThomasBley.pdf)
